...
public class TextureKeywordViewModel : INotifyPropertyChanged
{
    ...
    public string BaseColor { get => Get("BaseColor"); set => Set("BaseColor", value); }
    public string Normal { get => Get("Normal"); set => Set("Normal", value); }
    public string Roughness { get => Get("Roughness"); set => Set("Roughness", value); }
    public string AO { get => Get("AO"); set => Set("AO", value); }
    public string Metal { get => Get("Metal"); set => Set("Metal", value); }
    public string SelfIllum { get => Get("SelfIllum"); set => Set("SelfIllum", value); }
